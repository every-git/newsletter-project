...
1. summary_ko: 한국어 요약 (2문장, 핵심 내용만)
2. insight_ko: 왜 중요한지 인사이트 (1문장, 개발자 관점)
3. tags: 태그 배열 (ai, frontend, backend, infra, startup, security, mobile, general 중 1~2개 택)
4. score_llm: 개발자 관련성 점수 (0~100)

반드시 아래 형식의 JSON 배열만 반환하세요. 다른 텍스트 없이 JSON만:
[{"id":"원본id","summary_ko":"...","insight_ko":"...","tags":["ai"],"score_llm":85}, ...]
...
2. articles: 각 기사별 한줄 요약

반드시 아래 형식의 JSON만 반환하세요:
{"world_summary":"줄1\\n줄2\\n줄3\\n줄4\\n줄5","articles":[{"id":"원본id","summary_ko":"한줄요약","score_llm":50}, ...]}
